 ...
 */
FB_RETURN_TYPE
fb_init(unsigned int ph_w,
        unsigned int ph_h,
        unsigned int vrt_w,
        unsigned int vrt_h,
        unsigned int bpp,
        void** pp_fb,
        unsigned int* pfbsize,
        unsigned int* pPitch)
{
  unsigned int var;
  unsigned int count;
...
fb_set_xterm_palette()
{
  ...
  for (pi = 0; pi < 256; ++pi) {
    ...
    // RGB -> BGR
    pBuffData[off++] = (vc << 16 & 0xFF0000) | (vc & 0x00FF00) |
                       (vc >> 16 & 0x0000FF) | 0xFF000000;
  }
  pBuffData[off++] = 0; // end tag
...
FB_RETURN_TYPE
fb_blank_screen(unsigned int blank)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
...
FB_RETURN_TYPE
fb_set_depth(unsigned int* pDepth)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
...
FB_RETURN_TYPE
fb_get_pitch(unsigned int* pPitch)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
...
FB_RETURN_TYPE
fb_set_phisical_buffer_size(unsigned int* pWidth, unsigned int* pHeight)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
...
FB_RETURN_TYPE
fb_allocate_buffer(void** ppBuffer, unsigned int* pBufferSize)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
...
FB_RETURN_TYPE
fb_get_virtual_buffer_size(unsigned int* pVWidth, unsigned int* pVHeight)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
...
FB_RETURN_TYPE
fb_set_virtual_buffer_size(unsigned int* pWidth, unsigned int* pHeight)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
...
FB_RETURN_TYPE
fb_set_virtual_offset(unsigned int pX, unsigned int pY)
{
  volatile unsigned int pBuffData[256] __attribute__((aligned(16)));
  unsigned int off;
  unsigned int respmsg;
